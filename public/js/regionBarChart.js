function runBarChart() {
    ...
    const script = document.querySelector("#regionDailyCases");
    ...
    data.forEach((element) => {
        storeValues.push(element.cases);
        storeKeys.push(element.continent);
    });


    // rounded corner on bar chart
    ...
    var me = new Chart(continentChart, {
        type: 'horizontalBar',
        data: {
            labels: storeKeys,
            datasets: [{
            ...
            tooltips: {
                ...
                callbacks: {
                    label: function(tooltipItem, data) {
                        return tooltipItem.xLabel.toLocaleString("en-US") + " confirmed";
                    },
